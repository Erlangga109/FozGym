...
<div class="mt-4">
  <?php if (is_owner()): ?>
    <a class="btn btn-primary me-2" href="<?= get_base_url(); ?>/members/index.php">Kelola Member</a>
    <a class="btn btn-info me-2" href="<?= get_base_url(); ?>/enrollments/index.php">Kelola Pendaftaran</a>
  <?php endif; ?>
  <a class="btn btn-secondary me-2" href="<?= get_base_url(); ?>/classes/index.php">Kelola Kelas</a>
  <a class="btn btn-success" href="<?= get_base_url(); ?>/ai.php">AI Coach</a>
</div>
